    ...
    <ul class="pagination">
        <?php
                    ...
                    if($current_page > 1 && $page > 1){
                        ...
                        border: 1px solid #ddd;"><a href="tu-van-dang-ky-nhan-hieu-page'.($current_page-1).'">Prev</a></li>';
                    }
                    for($i=1;$i<=$page;$i++)
                    {
                    ?>
                        ...
                        <a href="tu-van-dang-ky-nhan-hieu-page<?php echo $i;?>"><?php echo $i;?></a></li>
                    <?php
                        }
                        // nút next
                        if($current_page < $page && $page > 1){
                            ...
                            text-decoration: none;
                            transition: background-color .3s;
                            border: 1px solid #ddd;"><a href="tu-van-dang-ky-nhan-hieu-page'.($current_page+1).'">Next</a></li>';
                        }
                    ?>
    </ul>
</div>
