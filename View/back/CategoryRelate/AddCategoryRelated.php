...
<div class="col-md-12 col-12 col-md-offset-4 title"><h3><b>ADD CATEGORY RELATED</b></h3></div>
...
<div class="row col-md-12 col-md-offset-4">
  ...
  ?>
    ...
    <form action="index.php?action=CategoryRelatedController&act=insert_action" method="post" enctype="multipart/form-data">
    <a style="margin-top:20px;margin-bottom:20px;" href="index.php?action=CategoryRelatedController&act=CategoryRelated" type="button" class="btn btn-default">Back</a>
