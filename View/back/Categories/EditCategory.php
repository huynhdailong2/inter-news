...
<div class="col-md-12 col-12 col-md-offset-4 title"><h3><b>EDIT CATEGORY</b></h3></div>
...
<div class="row col-md-12 col-md-offset-4">
  ...
  ?>
    <!--tạo thẻ form-->
    <?php
        echo '<form action="index.php?action=CategoryController&act=edit_action&id='.$id.'" method="post" enctype="multipart/form-data">';
    ?>
