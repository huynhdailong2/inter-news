...
<tr>
  <td>Mã thành viên</td>
  <td> <input type="text" class="form-control" name="in4_id" value="<?php if(isset($in4_id)) echo $in4_id;?>"readonly/></td>
</tr>
<tr>
  <td>Tên Thành viên</td>
  <td><input type="text" class="form-control" name="in4_name" value="<?php if(isset($in4_name)) echo $in4_name;?>"  maxlength="100px"></td>
</tr>
<tr>
  <td>Chức vụ</td>
  <td>
...
<tr>
  <td>Số điện thoại</td>
  <td><input type="text" class="form-control" name="in4_phone" value="<?php if(isset($in4_phone)) echo $in4_phone;?>"  maxlength="100px"></td>
</tr>     
<tr>
  <td>Email</td>
