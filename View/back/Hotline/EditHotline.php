...
<div class="row col-md-12 col-md-offset-4">
  ...
  ?>
    <!--tạo thẻ form-->
    <?php
        echo '<form action="index.php?action=HotlineController&act=edit_action&id='.$id.'"method="post" enctype="multipart/form-data">';
    ?>
    <a style="margin-top:20px;margin-bottom:20px;" href="index.php?action=HotlineController&act=Hotline"
    ...
    <table class="table" style="border: 0px;">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" name="link"
                    value="<?php if(isset($link)) echo $link;?>" maxlength="1000px"></td>
        </tr>
        <tr>
            <td colspan="2">
